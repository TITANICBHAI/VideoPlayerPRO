...
const CHANGELOG = [
  {
    ...
    date: "Mar 2026",
    changes: [
      "Redesigned tutorial with full-screen illustrated walkthrough",
      "Refreshed library, video cards and player screen UI",
      "Double-tap anywhere to seek — left half rewinds, right half skips",
      "Fixed controls never auto-hiding during playback",
      "Fixed gesture zones not adjusting in landscape/fullscreen",
      "Fixed tap/lock gesture stale-closure bugs",
      "Picture-in-Picture now only auto-starts when background playback is enabled",
      "Reduced stats polling re-renders for smoother playback",
